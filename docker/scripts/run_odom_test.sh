...
#
# Usage:
#   bash run_odom_test.sh --distance 1.0 --speed 0.05
#   bash run_odom_test.sh --distance 2.0 --speed 0.1 --csv /workspaces/MK-mini_ws/odom_test.csv
#
...
Options:
  ...
  --speed N       Target speed in m/s (default: 0.05)
  --csv PATH      CSV log output path (default: /tmp/mkmini_odom_test.csv)
  --dry-run       Print the command without executing (armed=false)

Examples:
  bash run_odom_test.sh --distance 0.5 --speed 0.05
  bash run_odom_test.sh --distance 2.0 --speed 0.1 --csv /workspaces/MK-mini_ws/odom_results.csv
